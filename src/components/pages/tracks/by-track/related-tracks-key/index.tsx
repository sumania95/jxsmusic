...
import { getRelatedCamelotKeyNames } from '@/lib/utils'
...
const TrackDetailRelatedKeyComponent = () => {
  ...
  const relatedKey = getRelatedCamelotKeyNames(
    getTrack?.in_key ?? ""
  )
  ...
  } = api.trackRelated.getAllRelatedKey.useQuery(
    {
      key: relatedKey,
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p
              ...
              "
            >
              Tracks with compatible Camelot keys
            </p>
          </div>
        </div>


        {!isLoading && track?.count?._count?.id !== undefined && (
          <span
            className="
              text-[9px]
              font-medium
...
export default TrackDetailRelatedKeyComponent