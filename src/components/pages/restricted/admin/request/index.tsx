...
const AdminUserRequestData = () => {
    ...
    const {data:user,isLoading} = api.user.getAllRequest.useQuery({
        search:search,
        ...
        >
            ...
            <div className="flex w-full flex-col gap-2 p-2 sm:p-3">
                ...
                {user?.user?.length === 0&&
                  ...
                  >
                      <div>
                          <UserRoundCheck className="mx-auto h-6 w-6 text-zinc-700" />
                          ...
                          <h3
                            ...
                            "
                          >
                              No request users found
                          </h3>

                          <p className="mt-1 text-[10px] text-zinc-700">
                              Try another search or wait for new user requests.
                          </p>
                      </div>
                  </div>
                }
            ...
            >
                <PaginationNewComponents
                    totalItems={Number(user?.count._count.id) ?? 0}
                />
            </div>
        </section>
    </div>
...
export default AdminUserRequestData