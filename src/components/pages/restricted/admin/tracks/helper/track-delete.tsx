...
const AdminAlertTrackDeleteComponent = ({
  id,
}: Props) => {
  ...
  const {
    mutateAsync: trackDelete,
    isPending: isDeleting,
  } = api.track.deleteAdmin.useMutation({
    onSuccess: async () => {
      await utils.track.getAllReleases.invalidate();
          ...
          <div className="px-5 py-5">
            ...
            >
              <p className="text-xs leading-6 text-zinc-400">
                ...
                delete the track from
                Jeff92 & Ayan Sumania. Any associated
                administrative record
                handled by this delete
                action will also be
                removed.
              </p>
            </div>
...
export default AdminAlertTrackDeleteComponent;