...
const AlertTrackDeleteComponent = (
  props: Props
) => {
  ...
  const {
    mutateAsync: testExist,
    isPending: isChecking,
  } =
    api.signedUrl.testExist.useMutation();

  const {
    mutateAsync: trackDelete,
    isPending: isDeleting,
  } =
    api.track.delete.useMutation({
      onSuccess: async () => {
          ...
          <div className="px-5 py-5">
            ...
            >
              <p className="text-xs leading-6 text-zinc-400">
                Deleting this track will
                remove the uploaded track
                record and its associated
                stored file when available.
...
export default AlertTrackDeleteComponent;