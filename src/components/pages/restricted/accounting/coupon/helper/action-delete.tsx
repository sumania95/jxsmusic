...
export const postSchema = Yup.object().shape({
  id: Yup.string().required("Coupon ID is required"),
});
          ...
          <div className="px-5 py-5">
            ...
            >
              <p className="text-xs leading-6 text-zinc-400">
                This coupon will be permanently removed from Jeff92 & Ayan Sumania and can no longer be used by customers.
              </p>
            </div>

            <p className="mt-3 text-[10px] leading-5 text-zinc-600">
              Make sure you selected the correct coupon before continuing.
            </p>
          </div>
