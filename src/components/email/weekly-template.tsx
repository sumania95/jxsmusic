        ...
        <Body className="m-0 bg-[#07080b] px-3 py-10 font-sans text-white">
          <Container className="mx-auto max-w-[620px] overflow-hidden rounded-2xl border border-[#23262f] bg-[#101217]">
            ...
            <Section className="border-y border-[#22262e] bg-[#151821] px-8 py-10">
              <Text className="mb-4 mt-0 text-[10px] font-extrabold tracking-[3px] text-violet-400">
                NEW THIS WEEK
              </Text>
              ...
              <Section className="rounded-xl bg-violet-600 px-6 py-6">
                <Text className="m-0 text-[52px] font-black leading-none tracking-[-2px] text-white">
                  {trackCount}
                </Text>

                <Text className="mb-0 mt-2 text-[10px] font-extrabold tracking-[2px] text-violet-200">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className="align-middle">
                            ...
                            {/* BPM + MEDIA TYPE */}
                            <Text className="m-0 text-[10px] font-extrabold tracking-[1.2px] text-violet-400">
                          ...
                          {track.trackUrl && (
                            <td className="w-14 text-right align-middle">
                              <Link
                                href={track.trackUrl}
                                className="text-[10px] font-extrabold tracking-[1px] text-violet-400 no-underline"
                              >
                                PLAY →
                              </Link>
                            </td>
